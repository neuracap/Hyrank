...
/**
 * Allowed difficulty band. Spec: only 2 and 3, exactly 50/50 of drawn inventory.
 * Implementation note: "exactly 50/50" is unreachable for odd totals or
 * fixed-mix groups — we aim for |L2 - L3| <= 1 and surface the actual split
 * in section_stats.
 */
export const ALLOWED_DIFFICULTIES = [2, 3];
