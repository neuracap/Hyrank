...
/**
 * Max PYQ-sourced picks per section (= 40% of SECTION_TOTAL).
 * CGL T1 builder allows up to this many CHSL-PYQ questions per section to
 * expand the pool beyond the bank — bank-tagged questions remain preferred
 * within every topic. Topic round-robin happens first; PYQ is the tiebreak
 * source when a topic's bank inventory is short.
 */
export const PYQ_CAP_PER_SECTION = Math.floor(SECTION_TOTAL * 0.4);  // 10
