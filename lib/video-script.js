...
// NotebookLM burns captions into videos and can't render Devanagari, so videos
// are generated from a Latin-script copy. This is transliteration of the sounds,
// NOT translation. Kept in sync with scripts/transliterate_video_scripts.js.
...
/**
 * Transliterate a Hinglish transcript's Devanagari into Latin script via Gemini.
 * Returns the romanized text. Throws on empty/failed response.
 */
export async function transliterateToLatin(text, { model = VIDEO_SCRIPT_MODEL } = {}) {
