...
// CHSL-specific drawn-question targets per section (sum to SECTION_TOTAL = 25).
// Diverges from CGL — CHSL leans heavily L3 in REASONING/QUANT, with GA and
// ENGLISH carrying the L2 share. Builder pre-fills the difficulty grid from here.
export const SECTION_DIFFICULTY_BASE = {
    REASONING: { L1: 0, L2: 0,  L3: 25, L4: 0 },
    GA:        { L1: 0, L2: 8,  L3: 17, L4: 0 },
    QUANT:     { L1: 0, L2: 0,  L3: 25, L4: 0 },
    ENGLISH:   { L1: 0, L2: 5,  L3: 20, L4: 0 },
};
